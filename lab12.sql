...
UPDATE TEACHER
SET 
    BIRTHDAY = TO_DATE('04.03.2006', 'DD.MM.YYYY'),
    SALARY = 10
WHERE PULPIT LIKE 'P%'
;
...
UPDATE TEACHER
SET 
    BIRTHDAY = TO_DATE('10.05.1989', 'DD.MM.YYYY'),
    SALARY = 14
...
UPDATE TEACHER
SET 
    BIRTHDAY = TO_DATE('04.12.2003', 'DD.MM.YYYY'),
    SALARY = 6
WHERE PULPIT LIKE 'O%'
;
...
UPDATE TEACHER
SET 
    BIRTHDAY = TO_DATE('11.12.1996', 'DD.MM.YYYY'),
    SALARY = 17
WHERE 
    SALARY IS NULL
